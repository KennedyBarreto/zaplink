...
export default function Nav() {
  ...
  return (
    <>
      <nav>
        <a href="#header">
          <h2 className="site-title">ZapLink</h2>
        </a>
        <ul>
          <a href="#form-data" onClick={scrollToForm}>
            CRIE SEU LINK
          </a>
          <a href="#steps">
            <li>PASSO-A-PASSO</li>
          ...
          <li>
            <a href="#header">ENTRE EM CONTATO</a>
          </li>
        </ul>

        <p id="hamburger" className="bars" size="30" onClick={showHideNav}>
          MENU
        </p>
      </nav>
